...
Requirements
------------
-  `sprockets.clients.statsd <https://github.com/sprockets/sprockets.clients.statsd>`_
...
Issues
------
Please report any issues to the Github project at `https://github.com/sprockets/sprockets.mixins.statsd/issues <https://github.com/sprockets/sprockets.mixins.statsd/issues>`_

Source
------
sprockets.mixins.statsd source is available on Github at `https://github.com/sprockets/sprockets.mixins.statsd <https://github.com/sprockets/sprockets.mixins.statsd>`_

License
-------
sprockets.mixins.statsd is released under the `3-Clause BSD license <https://github.com/sprockets/sprockets.mixins.statsd/blob/master/LICENSE>`_.
